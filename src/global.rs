...
//UNIX BASED PATHS
// pub(crate) const MONTY_DB_PATH: &str = "/Users/eugene/Desktop/project/monty_db/target/debug/monty_db";
...
// pub(crate) const FILE_PATH_SETUP: &str = "/Users/eugene/Desktop/project/monty_cli/target/debug/config.bin"; //config.bin
// pub(crate) const FILE_PATH_BACKGROUND_TASKS: &str = "/Users/eugene/Desktop/project/monty_cli/target/debug/background.bin"; //background.bin
